...
legend('SMF Normalized Intensity','Pixel Aperture Normalized Intensity');
set(gca,'FontSize',22);
ax = gca;
ax.YLim = [-5.5 -2.7];
figure(fig)
export_fig('RC_it_EFCSMF_v4Paper_Jan28.png','-r300');
...
legend('SMF Normalized Intensity','Mean DH Normalized Intensity','Pixel Aperture Normalized Intensity');
set(gca,'FontSize',22);
ax = gca;
ax.YLim = [-5.5 -2.7];
ax.XLim = [0 numit-1];
figure(fig)
export_fig('RC_it_regEFC_v4Paper_Jan28.png','-r300');
...
ax.YLim = [-5.5 -2.7];
figure(fig)
export_fig('RC_it_broadband_v4Paper_Jan28.png','-r300');
