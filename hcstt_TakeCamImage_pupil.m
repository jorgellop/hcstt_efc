...
function im = hcstt_TakeCamImage_pupil(setCExp,openhimg,CExp_new)

global cam img Xcr Ycr CExp s drv_inf flat itr Idat himg

% Idat = zeros(900,900,itr);
...
% Idat(:,:,1)  = img.Data(int16(Ycr-399):int16(Ycr+400),int16(Xcr-399):int16(Xcr+400));
% Idat(:,:,1)  = img.Data(int16(Ycr-449):int16(Ycr+450),int16(Xcr-449):int16(Xcr+450));
Idat  = img.Data;
% Idat  = img.Data;
im = Idat(:,:,1);
