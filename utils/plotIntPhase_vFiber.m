function plotIntPhase_vFiber(wf,wf0, k, info)
...
subplot(2,2,3)
imagesc([x_fib_pix-fiberDiam_pix/2+1:x_fib_pix+fiberDiam_pix/2]/lambdaOverD,[x_fib_pix-fiberDiam_pix/2+1:x_fib_pix+fiberDiam_pix/2]/lambdaOverD,angle(wf_trim));
colorbar; 
axis image;
set(gca,'FontSize',7)
...
subplot(2,2,1)
imagesc([x_fib_pix-fiberDiam_pix/2+1:x_fib_pix+fiberDiam_pix/2]/lambdaOverD,[y_fib_pix-fiberDiam_pix/2+1:y_fib_pix+fiberDiam_pix/2]/lambdaOverD,log10(abs(wf_trim).^2),[info.minint info.maxint]);
colorbar; 
axis image;
set(gca,'FontSize',7)
...
subplot(2,2,2)
imagesc([x_fib_pix-fiberDiam_pix/2+1:x_fib_pix+fiberDiam_pix/2]/lambdaOverD,[y_fib_pix-fiberDiam_pix/2+1:y_fib_pix+fiberDiam_pix/2]/lambdaOverD,log10(abs(Gu_trim).^2),[info.minint info.maxint]);
colorbar; 
axis image;
set(gca,'FontSize',7)
