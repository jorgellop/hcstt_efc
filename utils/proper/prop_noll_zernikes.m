function [zca, maxr, maxt] = prop_noll_zernikes(maxz, cmpt)
%        [zca, maxr, maxt] = prop_noll_zernikes(maxz, cmpt)
...
% cmpt = Compact: if set, the equations are returned using
%        the naming convention for terms assumed by prop_zernikes
